            ...
            <div class="col-lg-12 col-sm-12 col-xs-12">
                <div class="widget">
                    <div class="widget-header bordered-bottom bordered-blue">
                        <span class="widget-caption">Portfolio updaten</span>
                    </div>
                    <div class="widget-body">
                        <div>
                            <form role="form" id="form" method="post" action="/admin/portfolio/update/{{ $portfolio->id }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="title">Titel</label>
                                    <input type="text" class="form-control" id="title" name="title"
                                           placeholder="Titel..." required value="{{ $portfolio->title }}">
                                </div>
                                <div class="form-group">
                                    <label for="category">Categorie</label>
                                    <select name="category" style="width:100%;">
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}" {{ $portfolio->category_id == $category->id ? "selected='selected'" : "" }}/>
                                            {{ $category->value }}
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="pictureText" class="form-control" value="{{ $portfolio->image }}" readonly="">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" name="description">{{ $portfolio->description }}</textarea>
                                </div>
