        ...
        <ul class="contacts-list">
            <li class="contact">
                <div class="contact-avatar">
                    <img src="/beyondadmin/img/avatars/divyia.jpg" />
                </div>
            ...
            <li class="contact">
                <div class="contact-avatar">
                    <img src="/beyondadmin/img/avatars/Nicolai-Larson.jpg" />
                </div>
                <div class="contact-info">
            ...
            <li class="contact">
                <div class="contact-avatar">
                    <img src="/beyondadmin/img/avatars/John-Smith.jpg" />
                </div>
                <div class="contact-info">
            ...
            <li class="contact">
                <div class="contact-avatar">
                    <img src="/beyondadmin/img/avatars/Osvaldus-Valutis.jpg" />
                </div>
                <div class="contact-info">
            ...
            <li class="contact">
                <div class="contact-avatar">
                    <img src="/beyondadmin/img/avatars/Javi-Jimenez.jpg" />
                </div>
                <div class="contact-info">
            ...
            <li class="contact">
                <div class="contact-avatar">
                    <img src="/beyondadmin/img/avatars/Stephanie-Walter.jpg" />
                </div>
                <div class="contact-info">
            ...
            <li class="contact">
                <div class="contact-avatar">
                    <img src="/beyondadmin/img/avatars/Sergey-Azovskiy.jpg" />
                </div>
                <div class="contact-info">
            ...
            <li class="contact">
                <div class="contact-avatar">
                    <img src="/beyondadmin/img/avatars/Lee-Munroe.jpg" />
                </div>
                <div class="contact-info">
